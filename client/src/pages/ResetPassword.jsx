    ...
    <div className='flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-200 to-purple-400'>
      ...
      {!isEmailSent && 
        ...
        <form onSubmit={onSubmitEmail} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
          ...
          <p className='text-center mb-6 text-indigo-300'>Enter your registered emaill address</p>
          ...
          <button className='w-full py-2.5 bg-gradient-to-r from-indigo-500 to bg-indigo-900 text-white rounded-full mt-3'>Submit</button>
        </form>
